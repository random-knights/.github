...
<sub>98.8 percent of our input is cache reads, so that rule decides the answer by 8.7x.
Weighting a cache read at 0.1 instead gives <b>12.6 kWh, 5.4 kg CO₂e, 94 tree-days</b>.
...
| Equivalent | 109.9 kWh and 47.1 kg CO₂e is about |
| --- | --- |
| Phone charges | 9,155 |
| LED bulb hours | 10,986 |
| Laptop hours | 2,197 |
| Driving | 277 km |
| Tree-Time | 819 tree-days |
