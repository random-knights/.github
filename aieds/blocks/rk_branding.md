...
<sub>98.2 percent of our input is cache reads, so that rule decides the answer by 8.4x.
Weighting a cache read at 0.1 instead gives <b>0.8 kWh, 0.4 kg CO₂e, 6 tree-days</b>.
...
| Equivalent | 7.1 kWh and 3.0 kg CO₂e is about |
| --- | --- |
| Phone charges | 588 |
| LED bulb hours | 705 |
| Laptop hours | 141 |
| Driving | 18 km |
| Tree-Time | 53 tree-days |
