...
### 🌎 <span style="color:#EDC303"> Total **AiEDs** Usage | xyz-tools </span> 🏰
...
<sub>99.0 percent of our input is cache reads, so that rule decides the answer by 8.8x.
Weighting a cache read at 0.1 instead gives <b>1.8 kWh, 0.8 kg CO₂e, 13 days of Tree-Time</b>.
...
| --- | ---: | --- |
| Phone charges | 1,301 | 12 Wh per charge |
| LED bulb hours | 1,561 | 10 W bulb |
| Laptop hours | 312 | 50 W laptop |
| Driving distance | 39 km | 170 g CO₂e per km |
| Tree-Time | 116 days | 21 kg CO₂e per mature tree per year |
