...
Given(
  ...
  function (param1, param2, param3) {
    ...
    ProjectSuite.Variables.dboDatabaseServer = aqString.ToLower(
      "sql-standard-apis-shared-" + ProjectSuite.Variables.Environment,
    );
...
Given(
  ...
  function (param1) {
    Aliases.Browser.pageStandardIdentityDev.loginForm.WaitProperty(
      "VisibleOnScreen",
      true,
    );
    Log.Checkpoint(
      "| Redirected to Identity Login | - " +
        Aliases.Browser.pageStandardIdentityDev.URL,
    );
  },
);
...
When(
  ...
  function () {
    ...
    Aliases.Browser.pageStandardIdentityDev.loginForm.textboxEmail.SetText(
      emailVar,
    );
    Aliases.Browser.pageStandardIdentityDev.loginForm.textboxPass.SetText(
      passVar,
    );
    Log.Checkpoint(
...
Then(
  ...
  function (param1) {
    ...
    switch (ProjectSuite.Variables.Site) {
      case "Portal":
        Aliases.Browser.pageStandardPortal.panelAccounts.WaitProperty(
          "VisibleOnScreen",
          true,
        );
        ...
        break;
      case "Back Office":
        Aliases.Browser.pageStandardBackOffice.panelProfiles.WaitProperty(
          "VisibleOnScreen",
          true,
        );
