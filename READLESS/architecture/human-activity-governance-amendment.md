...
Author: Docs agent (owner directive + Fable ratification per session 24)
...
display widget, @scient1st context, or data file:
...
requires a separate Fable governance spec before implementation, following the
...
directive + new Fable governance spec.
...
| C9 | 2 | First Tier 2 vertical (flights or ships density — Fable spec required) |
