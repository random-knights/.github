...
| Primary | semantic slot only | app's main workflow and runtime behavior |
| Connections | shell and presentation primitives | provider setup, connection state, secrets |
...
- render/upload/FFmpeg workflows
- secret/test access rules
